...
def create_file(content='', title='Untitled'):
    ...
    notebook.add(container, text='Untitled')
...
def show_about_info():
    messagebox.showinfo(
        title='About',
        message='Simple text editor that I made following Jose Salvatierra during coding course.'
    )


root = tk.Tk()
root.geometry("920x880")
root.title("Big ass notebook")
...
file_menu.add_command(label='Create file', command=create_file, accelerator='Ctrl+N')
file_menu.add_command(label='Save the file', command=save_file, accelerator='Ctrl+S')
